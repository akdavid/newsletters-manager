...
class Summary:
    ...
    def get_compression_ratio(self) -> float:
        ...
        total_original = sum(
            item.original_length for item in self.newsletters_summaries
        )
    ...
    def get_average_confidence(self) -> float:
        ...
        return sum(item.confidence_score for item in self.newsletters_summaries) / len(
            self.newsletters_summaries
        )
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "newsletters_summaries": [
                item.to_dict() for item in self.newsletters_summaries
            ],
