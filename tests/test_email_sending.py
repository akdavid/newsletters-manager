...
def test_email_sending():
    ...
    print(f"🔐 Password: {'✅ Set' if smtp_password and smtp_password != 'your_app_password_here' else '❌ Not configured'}")
    print()
    
    if not smtp_username or not smtp_password or smtp_password == 'your_app_password_here':
    ...
    try:
        ...
        print("1. Make sure you created a Gmail App Password (not your regular password)")
